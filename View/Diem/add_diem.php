...
<head>
  ...
  <title>Thêm Điểm môn học</title>
      ...
      <div class="container-fluid">
        ...
        <div class="container">
          <div class="card card-login mx-auto mt-5">
            <div class="card-header">Thêm điểm môn học</div>
            <div class="card-body">
              <form action="#" method="POST">
                ...
                <div class="form-group">
                  ...
                  <br>
                  <label for="sel2">Tên môn học</label>
                ...
                <div class="form-group">
                  <div class="form-label-group">
                    <input type="text" name="txt_diemTHK" id="inputdiemTHK" class="form-control" placeholder="Điểm Cuối kì" required="required">
                    <label for="inputdiemTHK">Điểm Cuối kì</label>
                  </div>
                </div>
