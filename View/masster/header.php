...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
  ...
  <form action="index.php?controllers=quanly&action=Seach" method="POST" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
    <div class="input-group">
      <input type="text" class="form-control" name="gtTimkiem" placeholder="Tìm kiếm Học sinh">
  ...
  <ul class="navbar-nav ml-auto ml-md-0">
    ...
    <li class="nav-item dropdown no-arrow">
      ...
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
        <a class="dropdown-item" href="index.php?controllers=login&action=cai_dat&username=<?php echo $user; ?>">Cài đặt tài khoản</a>
